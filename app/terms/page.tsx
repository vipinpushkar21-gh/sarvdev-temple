  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 bg-background p-8 rounded-2xl shadow-lg border border-accent text-text">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-primary mb-3">4. Content Moderation</h2>
          <p className="leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-primary mb-3">6. Disclaimer of Warranties</h2>
          <p className="leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-primary mb-3">9. Contact</h2>
          <p className="leading-relaxed">
            For questions about these Terms of Service, please <a href="/contact" className="hover:underline">contact us</a>.
          </p>
        </div>
      </div>
    </main>
