  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        ...
        slug: 'kartikeya-ji-murugan-skanda',
      },
      {
        name: 'Hanuman Ji',
        nameHi: 'हनुमान जी',
      ...
      },
      {
        ...
        descriptionHi: 'शिर्डी, महाराष्ट्र के पूज्य सन्त जिन्हें करोड़ों भक्त देवता के रूप में पूजते हैं। "सबका मालिक एक" का सन्देश और हिन्दू-मुस्लिम एकता के पक्षधरत जीर्ण मस्जिद (द्वारकामाई) में रहे और धूनी सदा प्रज्वलित रखी। उनकी शिक्षाओं का सार — श्रद्धा और सबूरी (धैर्य)।',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Siddhidatri',
        nameHi: 'सिद्धिदात्री',
        description: 'The bestower of supernatural powers (Siddhis). Worshipped on the ninth day. She has four arms and sits on a lotus. She grants all types of Siddhis to her devotees. Lord Shiva attained all Siddhis from her.',
        descriptionHi: 'सिद्धियों की दात्री। नवें दिन पूजित। चार भुजाएँ और कमल पर विराजमान। भक्तों को सभी प्रकार की सिद्धियाँ प्रदान करती हैं। भगवान शिव ने उनसे सभी सिद्धियाँ प्राप्त कीं।',
        attributes: ['Day 9', 'Siddhis', 'Lotus', 'Supreme Power'],
        slug: 'siddhidatri',
      },
    ],
  },
    ...
    deities: [
      {
        ...
        descriptionHi: 'समय, संहार और मोक्ष की भयंकर देवी। प्रथम और प्रमुख महाविद्या। वे भगवान शिव पर खड़ी हैं, मुण्डमाला पहने, और जीभ बाहर निकाले हुए। वे बुराई और अहंकार का नाश करती हैं।',
        mantra: 'ॐ क्रीं कालिकायै नमः',
        attributes: ['Time', 'Liberation', 'Skulls', 'Shiva'],
        slug: 'kali',
      },
      {
        name: 'Tara',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Vishwakarma',
        nameHi: 'विश्वकर्मा',
        description: 'The Divine Architect and craftsman of the gods. He built Lanka for Kubera (later taken by Ravana), Dwarka for Krishna, Indraprastha for the Pandavas, and designed the weapons of the gods including Vishnu Sudarshana Chakra.',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Ketu',
        nameHi: 'केतु',
        description: 'The South Node — the shadow planet of spirituality and detachment. He governs moksha, past karma, occult knowledge, and liberation. Gemstone is Cat Eye (Lehsunia).',
        descriptionHi: 'केतु — छाया ग्रह, आध्यात्मिकता और वैराग्य का कारक। मोक्ष, पूर्वजन्म कर्म, तान्त्रिक ज्ञान और मुक्ति के कारक। रत्न — लहसुनिया (Cat Eye)।',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Gaja Lakshmi',
        nameHi: 'गज लक्ष्मी',
        description: 'The form flanked by elephants (Gaja) who shower her with water. She represents royalty, power, and animal wealth. She restored Indra lost wealth.',
    ...
    deities: [
      {
        ...
        attributes: ['Cursed', 'Dronacharya Son', 'Mahabharata'],
        slug: 'ashwatthama',
      },
      {
        name: 'Raja Bali',
      ...
      },
      {
        ...
        slug: 'hanuman-ji-chiranjeevi',
      },
      {
        name: 'Vibhishana',
        nameHi: 'विभीषण',
        description: 'The righteous brother of Ravana who sided with Lord Rama during the Lanka war. After Ravana defeat, Rama crowned him as the king of Lanka and granted him immortality to uphold dharma.',
        ...
        attributes: ['Ravana Brother', 'King of Lanka', 'Dharma'],
        slug: 'vibhishana',
      },
      {
        name: 'Kripacharya',
      ...
      },
      {
        ...
        attributes: ['Vishnu Avatar', 'Axe (Parashu)', 'Kalki Guru'],
        slug: 'parashurama-chiranjeevi',
      },
    ],
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Govardhandhari',
        nameHi: 'गोवर्धनधारी',
        description: 'Krishna lifting the Govardhan mountain on his little finger to protect Vrindavan from Indra wrath and torrential rains for seven days and nights.',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Bharat',
        nameHi: 'भरत',
        description: 'The second brother who refused the throne when Rama went to exile. He placed Rama sandals (Paduka) on the throne and ruled as his representative from Nandigram.',
    ...
    deities: [
      {
        name: 'Ganga',
        nameHi: 'गंगा',
        description: 'The holiest river. Descended from heaven through Shiva matted hair. A bath in the Ganga washes away all sins. Daughter of Himavan and sister of Parvati.',
      ...
      },
      {
        name: 'Yamuna',
        nameHi: 'यमुना',
        description: 'Daughter of Surya Dev and sister of Yama. Flows through Mathura-Vrindavan, Krishna land. Bathing frees from fear of death.',
      ...
      },
      {
        ...
        slug: 'saraswati-river',
      },
      {
        name: 'Godavari',
        nameHi: 'गोदावरी',
        description: 'The Dakshin Ganga (Ganga of the South). Originates in Nashik from Rishi Gautama ashram. Longest river of South India.',
  ...
  },
  {
    ...
    deities: [
      ...
      },
      {
        name: 'Angad',
        nameHi: 'अंगद',
        description: 'Son of Bali. Sent as Rama ambassador to Ravana court, he planted his foot and challenged anyone to move it — none could.',
