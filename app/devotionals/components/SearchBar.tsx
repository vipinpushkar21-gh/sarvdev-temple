...
export const SearchBar: React.FC<SearchBarProps> = ({ value, onChange, placeholder }) => (
  <div className="mb-6">
    ...
    <input
      ...
      type="search"
      className="w-full px-4 py-2 rounded-lg border border-accent bg-background text-text focus:outline-none focus:ring-2 focus:ring-primary-400 transition-colors shadow-sm"
