  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-surface-border bg-dark-sacred text-white">
      ...
      <SarvdevImage
        ...
        renderMode="auto"
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#171411_0%,#1c140f_39%,rgba(23,20,17,0.7)_57%,rgba(23,20,17,0.18)_100%)]" />
      ...
      <div className="page-container relative min-h-[530px] sm:min-h-[590px] lg:min-h-[620px]">
        <div className="relative z-10 flex max-w-[42rem] flex-col justify-center py-5 sm:py-14 lg:py-20">
          ...
          <h1 className="mt-3 max-w-2xl font-display text-[2.3rem] font-semibold leading-[0.98] tracking-[-0.025em] text-white sm:mt-5 sm:text-[clamp(2.75rem,5.2vw,4.35rem)]">
          ...
          <div className="mt-5 max-w-2xl rounded-card border border-white/15 bg-white/[0.06] p-2.5 shadow-card sm:mt-8 sm:p-4">
