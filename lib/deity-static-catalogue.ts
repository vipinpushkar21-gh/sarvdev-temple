/**
 * Static editorial deity catalogue.
 * Reference content for admin tooling only — public pages read live database records.
 */
...
export interface StaticDeityCategory {
  id: string
  title: string
  titleHi: string
  subtitle: string
...
export const DEITY_CATEGORIES: StaticDeityCategory[] = [
  {
    id: 'tridev',
    title: 'Tridev',
    titleHi: 'त्रिदेव',
